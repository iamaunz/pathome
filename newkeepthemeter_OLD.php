...
<div data-role="page">
	...
	<div data-role="header"  data-theme="b" data-position="fixed" >
    	<a href="room.php" data-icon="delete">Cancel</a>
    ...
    <form name="admin" id="admin" action="controllers.php" method="post">
        ...
        <?php if($outputroom[0]['waterperunitGov']==0){?>
          <div data-role="fieldcontain" class="ui-hide-label">
            <label for="waterpermonth">น้ำ:</label>
            <input type="text" name="waterpermonth" id="waterpermonth" value="<?php echo  $output[0]['waterpermonth'] ?>" placeholder="น้ำ"/>
          </div>
          <?php }else{ ?>
          <div data-role="fieldcontain" class="ui-hide-label">
          	ค่าน้ำองค์การ 
            <label for="water">ค่าน้ำองค์การ :</label>
            <input type="text" name="water" id="water" value="<?php echo  $output[0]['water'] ?>" placeholder="ค่าน้ำองค์การ "/>
          </div>
          <?php } ?>
        </li>
        <li> 
         <?php if($outputroom[0]['chargeperunitGov']==0){?>
          <div data-role="fieldcontain" class="ui-hide-label">
            <label for="chargepermonth">ไฟ:</label>
            <input type="text" name="chargepermonth" id="chargepermonth" value="<?php echo  $output[0]['chargepermonth'] ?>" placeholder="ไฟ"/>
          </div>
          <?php }else{?>
           <div data-role="fieldcontain" class="ui-hide-label">
            ค่าไฟองค์การ
            <label for="water">ค่าไฟองค์การ :</label>
            <input type="text" name="charge" id="charge" value="<?php echo  $output[0]['charge'] ?>" placeholder="ค่าไฟองค์การ"/>
          </div>
          <?php } ?>
        </li>
