...
//$result = $db->getRentPerMonnth($_GET['month'],$_GET['year'],$_GET['id']);
...
if($_GET['month'] == "1"){
	...
	//$meter = $db->getMeterTwoLastMonthDESC($rs['idRoom'], 13, $_GET['year']);
	//$meter = $db->getMeterTwoLastMonthDESC($rs['idRoom'], 12, $_GET['year']);
}else{
