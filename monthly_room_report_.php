...
$html = '<table>
		<tr>
			<td valign="bottom" align="left" width="50%"><h5>ห้อง</h5></td>
			<td valign="bottom" align="right" width="50%"><h5>ค่าห้องรวม</h5></td>
		</tr>';
...
while($rs = mysql_fetch_array($result)){
	...
	$html = $html.'
		<tr>
			<td valign="bottom" align="left" width="50%">'.$rs['roomName'].'</td>
			<td valign="bottom" align="right" width="50%">'.number_format($total_price,2).'</td>
		</tr>
	';
}
...
$html = $html.'
		<tr>
			<td valign="bottom" align="left" width="50%"><h4>รวม</h4></td>
			<td valign="bottom" align="right" width="50%"><h4>'.number_format($total_month,2).'</h4></td>
		</tr>
	</table>';
	/*
		<tr>
